...
return [
    ...
    */
    ...
    'namespace' => [
        ...
        'model'             => 'App\API\{version}\Models',

        'datatables'        => 'App\API\{version}\DataTables',

        'repository'        => 'App\API\{version}\Repositories',

        'controller'        => 'App\API\{version}\Controllers',

        'transformer'        => 'App\API\{version}\Transformers',
    ],
